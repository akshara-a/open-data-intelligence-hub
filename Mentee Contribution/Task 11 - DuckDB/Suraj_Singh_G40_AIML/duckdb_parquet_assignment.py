...
data = {
    ...
    # employee name
    "name": ["rohit","Abhinav","Neha","Prashant","Adhya","Arjun","Manoj","kallu"],
    # employee department
    "department": ["IT","HR","IT","Finance","HR","Finance","IT","Sales"],
    # employee salary
    "salary": [60000,45000,70000,55000,49500,61000,73000,65000],
    # employee city
...
print("name, department, salary (sorted by salary desc) ===")
...
print("Filtered Parquet file created (high_salary_employees.parquet) ===")
print()
...
# Extra Work: Additional Queries and Analysis
# =========================================================
print("=== Extra work ===")
