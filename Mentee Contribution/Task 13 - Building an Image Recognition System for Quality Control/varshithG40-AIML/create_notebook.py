...
Generates a complete, executable Jupyter notebook notebooks/casting_defect_detection.ipynb
"""
...
with open("notebooks/casting_defect_detection.ipynb", "w") as f:
    json.dump(notebook_content, f, indent=1)

print("Created notebooks/casting_defect_detection.ipynb successfully.")
