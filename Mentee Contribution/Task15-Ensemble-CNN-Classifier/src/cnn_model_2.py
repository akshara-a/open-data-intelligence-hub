...
def build_model():
    """Build CNN Model 2 with a different architecture."""
...
def plot_history(history):
    """Save CNN Model 2 training graphs."""
...
def main():
    ...
    print("\nEvaluating CNN Model 2 on test data...")
    ...
    print("\n" + "=" * 60)
    print("CNN MODEL 2 TEST RESULTS")
    print("=" * 60)
    ...
    print(
        "\nTASK 15 CNN MODEL 2 COMPLETED SUCCESSFULLY."
    )
